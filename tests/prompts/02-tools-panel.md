...
Linux, CMake, clang. Output everything under `tests/02-tools-panel/` with a README that has build/run instructions. I do not need you to actually invoke the compiler — just produce the working files.
