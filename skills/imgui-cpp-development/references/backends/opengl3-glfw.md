...
>
> **Tier guidance:** Tier 1 covers the 80% case — init/shutdown sequence, per-frame ordering, the multi-viewport save/restore wrap, and common pitfalls. Tier 2 is the API reference (platform + renderer surfaces, GL loader, GLSL version selection, texture identifiers). Tier 3 is the bundled-template pointer plus see-also. Default load: Tier 1 only via the Quick navigation below.

<!-- QUICK_NAV_BEGIN -->
> **Quick navigation** (jump to a section instead of loading the whole file - `Read offset=N limit=M`):
>
> - L  28-64   1. Init and shutdown
> - L  65-87   2. Per-frame ordering
> - L  88-110  3. Multi-viewport on GLFW
> - L 111-142  4. Common pitfalls
> - L 143-148  5. What this backend is
> - L 149-179  6. Public API surface
> - L 180-194  7. The `glsl_version` argument
> - L 195-204  8. GL loader
> - L 205-227  9. `ImTextureID` and `ImTextureRef`
> - L 228-247  10. Bundled main.cpp template
> - L 248-252  See also
<!-- QUICK_NAV_END -->
...
## 9. `ImTextureID` and `ImTextureRef`
